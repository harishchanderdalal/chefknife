...
sudo mkdir .chef
sudo chef-server-ctl user-create root root root root@agility.com password -f ~/.chef/root.pem
sudo chef-server-ctl org-create master "master.com" --association_user root -f ~/.chef/master.pem
